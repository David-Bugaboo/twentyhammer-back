...
const isAdmin_decorato_1 = require("../../../common/decorators/isAdmin.decorato");
const isPublic_decorator_1 = require("../../../common/decorators/isPublic.decorator");
let JwtAuthGuard = class JwtAuthGuard extends (0, passport_1.AuthGuard)('jwt') {
    ...
    handleRequest(err, user, info, context) {
        ...
        const isAdmin = this.reflector.getAllAndOverride(isAdmin_decorato_1.IS_ADMIN_KEY, [
            context.getHandler(),
            context.getClass(),
        ]);
