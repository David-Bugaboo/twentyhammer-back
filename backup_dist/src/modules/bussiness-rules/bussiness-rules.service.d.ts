...
export declare class BussinessRulesService {
    ...
    validateSkill(skillSlug: string, warbandSoldierSkills: string[], warbandSoldierSkillLists: string[], warbandSoldierAdvancements: string[]): Promise<void>;
    validateSpell(spellSlug: string, warbandSoldierSpellLores: string[], warbandSoldierSpells: string[], warbandSoldierSkills: string[], warbandSoldierAdvancements: string[]): Promise<void>;
