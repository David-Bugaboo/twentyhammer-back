...
export declare abstract class QueriesRepository {
    ...
    abstract findAllAdvancements(dto: AdvancementQueryDto): Promise<Advancement[]>;
    ...
    abstract findAllSuperNaturalAbilities(dto: SuperNaturalAbilityQueryDto): Promise<SuperNaturalAbility[]>;
    abstract findSuperNaturalAbilityByslug(slug: string): Promise<SuperNaturalAbility>;
