...
export declare abstract class SoldiersRepository {
    ...
    abstract addEquipmentToSoldier(soldierId: string, warbandVaultItem: EquipmentToVault): Promise<void>;
    abstract removeEquipmentFromSoldier(warbandToSoldierItemId: string): Promise<void>;
