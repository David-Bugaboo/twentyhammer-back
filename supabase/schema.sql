...
CREATE TABLE IF NOT EXISTS "public"."extra_skill_list_to_warband_soldier" (
    "id" "text" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."extra_skill_list_to_warband_soldier" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."extra_spell_lore_to_warband_soldier" (
    "id" "text" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."extra_spell_lore_to_warband_soldier" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."gift_of_tzeentch" (
    "id" "text" DEFAULT "gen_random_uuid"() NOT NULL,
    "slug" "text" NOT NULL,
    "name" "text" NOT NULL,
    "description" "text" NOT NULL,
...
ALTER TABLE "public"."gift_of_tzeentch" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."gift_of_tzeentch_to_warband_soldier" (
    "id" "text" DEFAULT "gen_random_uuid"() NOT NULL,
    "gift_of_tzeentch_slug" "text" NOT NULL,
    "warband_soldier_id" "text" NOT NULL,
    "created_at" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);


ALTER TABLE "public"."gift_of_tzeentch_to_warband_soldier" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."extra_skill_list_to_warband_soldier"
    ADD CONSTRAINT "extra_skill_list_to_warband_soldier_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."extra_spell_lore_to_warband_soldier"
    ADD CONSTRAINT "extra_spell_lore_to_warband_soldier_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."gift_of_tzeentch"
    ADD CONSTRAINT "gift_of_tzeentch_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."gift_of_tzeentch_to_warband_soldier"
    ADD CONSTRAINT "gift_of_tzeentch_to_warband_soldier_pkey" PRIMARY KEY ("id");
...
CREATE UNIQUE INDEX "gift_of_tzeentch_slug_key" ON "public"."gift_of_tzeentch" USING "btree" ("slug");
...
ALTER TABLE ONLY "public"."extra_skill_list_to_warband_soldier"
    ADD CONSTRAINT "extra_skill_list_to_warband_soldier_skill_list_slug_fkey" FOREIGN KEY ("skill_list_slug") REFERENCES "public"."skill_lists"("slug") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."extra_skill_list_to_warband_soldier"
    ADD CONSTRAINT "extra_skill_list_to_warband_soldier_warband_soldier_id_fkey" FOREIGN KEY ("warband_soldier_id") REFERENCES "public"."warband_soldier"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."extra_spell_lore_to_warband_soldier"
    ADD CONSTRAINT "extra_spell_lore_to_warband_soldier_spell_lore_slug_fkey" FOREIGN KEY ("spell_lore_slug") REFERENCES "public"."spell_lores"("slug") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."extra_spell_lore_to_warband_soldier"
    ADD CONSTRAINT "extra_spell_lore_to_warband_soldier_warband_soldier_id_fkey" FOREIGN KEY ("warband_soldier_id") REFERENCES "public"."warband_soldier"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."gift_of_tzeentch_to_warband_soldier"
    ADD CONSTRAINT "gift_of_tzeentch_to_warband_soldier_gift_of_tzeentch_slug_fkey" FOREIGN KEY ("gift_of_tzeentch_slug") REFERENCES "public"."gift_of_tzeentch"("slug") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."gift_of_tzeentch_to_warband_soldier"
    ADD CONSTRAINT "gift_of_tzeentch_to_warband_soldier_warband_soldier_id_fkey" FOREIGN KEY ("warband_soldier_id") REFERENCES "public"."warband_soldier"("id") ON UPDATE CASCADE ON DELETE CASCADE;
